...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'demo4_bookreview', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='review_user', to=orm['auth.User'])),
            ('book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='review_book', to=orm['demo4.Book'])),
        ))
        db.send_create_signal(u'demo4', ['BookReview'])


    def backwards(self, orm):
        # Deleting model 'BookReview'
        db.delete_table(u'demo4_bookreview')
