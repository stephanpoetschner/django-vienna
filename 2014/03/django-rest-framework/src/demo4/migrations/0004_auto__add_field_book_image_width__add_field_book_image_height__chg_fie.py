...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Book.image_width'
        db.add_column(u'demo4_book', 'image_width',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Book.image_height'
        db.add_column(u'demo4_book', 'image_height',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, null=True),
                      keep_default=False)


        # Changing field 'Book.image'
        db.alter_column(u'demo4_book', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Book.image_width'
        db.delete_column(u'demo4_book', 'image_width')

        # Deleting field 'Book.image_height'
        db.delete_column(u'demo4_book', 'image_height')


        # User chose to not deal with backwards NULL issues for 'Book.image'
        raise RuntimeError("Cannot reverse this migration. 'Book.image' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Book.image'
        db.alter_column(u'demo4_book', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    models = {
        ...
        u'demo4.bookreview': {
            ...
            'book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'book_reviews'", 'to': u"orm['demo4.Book']"}),
