...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Book.created_by'
        db.add_column(u'demo2_book', 'created_by', self.gf(
            'django.db.models.fields.related.ForeignKey')(
            default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.created_by'
        db.delete_column(u'demo2_book', 'created_by_id')
    ...
    models = {
        ...
        u'demo2.book': {
            ...
            'authors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'book_authors'", 'symmetrical': 'False', 'through': u"orm['demo2.BookAuthors']", 'to': u"orm['demo2.Author']"}),
